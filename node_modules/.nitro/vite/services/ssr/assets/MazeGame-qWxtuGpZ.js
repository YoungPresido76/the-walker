...
function TitleOverlay({ onEnter }) {
	return /* @__PURE__ */ jsxs(OverlayCard, { children: [
		/* @__PURE__ */ jsx("p", {
		...
		/* @__PURE__ */ jsxs("p", {
			...
			children: ["WASD to walk · mouse to look · H to peek", /* @__PURE__ */ jsx("span", {
...
function Hud({ runtime, onHint }) {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		...
		playing && touch ? /* @__PURE__ */ jsx(LookPad, { input: runtime.input }) : null,
		playing ? /* @__PURE__ */ jsxs("div", {
			...
			children: [touch ? /* @__PURE__ */ jsx(Joystick, { input: runtime.input }) : /* @__PURE__ */ jsx("span", {}), /* @__PURE__ */ jsxs("button", {
				type: "button",
				onClick: onHint,
		...
		playing ? /* @__PURE__ */ jsx("div", { className: "pointer-events-none absolute top-1/2 left-1/2 z-10 size-1 -translate-x-1/2 -translate-y-1/2 rounded-full bg-fg/70" }) : null
	] });
}
//#endregion
...
function ColoredInstances({ items, shape = "box", castShadow = false, receiveShadow = false, roughness = .9, flatShading = false }) {
	...
	return /* @__PURE__ */ jsxs("instancedMesh", {
		...
		receiveShadow,
		frustumCulled: false,
		children: [shape === "ico" ? /* @__PURE__ */ jsx("icosahedronGeometry", { args: [1, 0] }) : /* @__PURE__ */ jsx("boxGeometry", { args: [
			1,
			1,
			1
...
function Trees({ maze }) {
	return /* @__PURE__ */ jsx("group", { children: maze.trees.map((t, i) => /* @__PURE__ */ jsxs("group", {
		position: [
			t.x,
			0,
			t.z
		...
		children: [/* @__PURE__ */ jsxs("mesh", {
			...
			castShadow: true,
			children: [/* @__PURE__ */ jsx("icosahedronGeometry", { args: [1.15 * t.scale, 0] }), /* @__PURE__ */ jsx("meshStandardMaterial", {
				color: t.hue,
				roughness: .86,
				flatShading: true
			})]
	...
	return /* @__PURE__ */ jsxs("group", {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("mesh", {
				...
				children: [/* @__PURE__ */ jsx("circleGeometry", { args: [1.35, 12] }), /* @__PURE__ */ jsx("meshBasicMaterial", {
					color: WORLD.exitGlow,
					transparent: true,
					opacity: .14
				})]
...
function Orbs({ maze, runtime }) {
	...
	return /* @__PURE__ */ jsx("group", {
		ref: group,
		children: maze.collectibles.map((c, i) => /* @__PURE__ */ jsxs("group", {
			position: [
				c.x,
				.82,
				c.z
			],
			children: [/* @__PURE__ */ jsxs("mesh", { children: [/* @__PURE__ */ jsx("icosahedronGeometry", { args: [.16, 0] }), /* @__PURE__ */ jsx("meshStandardMaterial", {
				color: WORLD.orb,
				emissive: WORLD.orb,
				emissiveIntensity: 1.8,
				roughness: .35,
				flatShading: true
			})] }), i < 4 ? /* @__PURE__ */ jsx("pointLight", {
				color: WORLD.orb,
				intensity: .85,
				distance: 3.4,
				decay: 2
...
function World({ maze, runtime }) {
	...
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		...
		/* @__PURE__ */ jsxs("mesh", {
			...
			receiveShadow: true,
			children: [/* @__PURE__ */ jsx("planeGeometry", { args: [160, 160] }), /* @__PURE__ */ jsx("meshStandardMaterial", {
				map: grass,
				roughness: .95,
				metalness: 0
			})]
		}),
		/* @__PURE__ */ jsx(ColoredInstances, {
			items: maze.paths,
			receiveShadow: true,
			roughness: .96
		}),
		...
		/* @__PURE__ */ jsx(Trees, { maze }),
		/* @__PURE__ */ jsx(Gate, { maze }),
		/* @__PURE__ */ jsx(Orbs, {
			maze,
			runtime
		}),
		/* @__PURE__ */ jsx(HintArrow, { runtime }),
		/* @__PURE__ */ jsxs("mesh", {
			position: [
				cx,
				WALL_HEIGHT + 6,
...
function MazeGame() {
	...
	return /* @__PURE__ */ jsx(HedgerowRun, {
		seed,
		autostart,
		onReplay: () => {
			setAutostart(true);
...
function HedgerowRun({ seed, autostart, onReplay }) {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			...
			phase === "title" ? /* @__PURE__ */ jsx(TitleOverlay, { onEnter: startPlay }) : null,
			phase === "paused" && !locked && !touch ? /* @__PURE__ */ jsx(PauseOverlay, { onResume: startPlay }) : null,
			phase === "won" ? /* @__PURE__ */ jsx(WinOverlay, {
				time: wonTime,
				collected,
				total,
				onReplay
