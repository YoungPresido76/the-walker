...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BOArVg4H.js
var router_BOArVg4H_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-Dk6btnxh.css";
var APP_NAME = "Hedgerow";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "A first-person garden maze. Find the gate before the hedges steal your sense of direction."
			},
			{
				name: "theme-color",
				content: "#121c16"
...
var $$splitComponentImporter = () => import("./routes-BrFQewEH.mjs");
...
//#endregion
export { getRouter, router_BOArVg4H_exports as t };
